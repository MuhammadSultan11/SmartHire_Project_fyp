...
from django.urls import path
from .candidate_views import apply_job,task_status, get_resumes, candidate_profile, api_profile,api_experience, api_education, api_certification, api_project, api_skill,api_profile_picture, process_resume, submit_resume
from django.conf import settings
from django.conf.urls.static import static
...
urlpatterns = [
    ...
    # Temp urls for testing purposes
    path('jobs', api_skill, name='jobs'),
    path('companies', api_skill, name='companies'),
    path('resources', api_skill, name='resources'),
    path('about', api_skill, name='about'),
    path('my_applications', api_skill, name='my_applications'),
    path('saved_jobs', api_skill, name='saved_jobs'),
    path('contact', api_skill, name='contact'),
    path('salaries', api_skill, name='salaries'),
